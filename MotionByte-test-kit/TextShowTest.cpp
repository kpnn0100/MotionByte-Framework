...
int main(int argc, char* argv[]) {
	...
	FT_Face face;
	FT_New_Face(ft, "G:/Dev/MotionByte_framework/Resource/Roboto-Regular.ttf", 0, &face);
	...
	glUniform3f(6, 0.88f, 0.10f, 0.07f);
...
GLuint CompileShaders(bool vs_b, bool tcs_b, bool tes_b, bool gs_b, bool fs_b) {
	...
	if (tcs_b) {
		...
		glShaderSource(tcs, 1, &vertexShaderSource, NULL);
		glCompileShader(tcs);
